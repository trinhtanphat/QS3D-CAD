...
internal static class CadBackendQualificationModuleSmoke
{
    ...
    internal static void Run()
    {
        ...
        Throws<InvalidOperationException>(() => CadQualifiedBackendSelector.SelectProduction(
            ...
            new[]
            {
                new CadBackendQualificationEvidence(native.Id, "1.0.0", SourceA, CadCapabilities.TwoDimensional, DateTimeOffset.UtcNow, "failed", false)
            },
        ...
        Console.WriteLine("PASS exact-SHA native backend qualification policy");
    }
