...
Never weaken tests, architecture/vendor-isolation/persistence guards, security checks, packaging/release gates or expected behavior merely to obtain green CI.
